      ...
      <div class="tab" id="tab1">
        ...
        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              id="itin_number"
              name="itin_number"
              value="{{ old('itin_number') }}"
            />
          </div>
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            <label for="company" style="font-weight: 900; font-style: italic;">Memo</label>
            <textarea id="memo_field" name="memo" rows="4" value="{{ old('memo') }}"  class="form-control form-control-user @error('memo') is-invalid @enderror" style="font-style: italic; font-weight: bold;">{{ old('memo') }}</textarea>
          </div>
        ...
        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
          ...
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              value="{{ old('driver_issuing_authority') }}"
            />
          </div>
         ...
         <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
          ...
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              value="{{ old('birth_place_of_birth') }}"
            />
          </div>
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
          ...
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              value="{{ old('birth_registration_number') }}"
            />
          </div>
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              value="{{ old('birth_issuing_authority') }}"
            />
          </div>
          ...
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              value="{{ old('passport_nationality') }}"
            />
          </div>
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
            ...
            <input
              ...
              value="{{ old('passport_place_of_birth') }}"
            />
          </div>
          <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      var src = URL.createObjectURL(this.files[0])
        ...
        var sec = document.getElementById("image_list");
        sec.appendChild(img);
