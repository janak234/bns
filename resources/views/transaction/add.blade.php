...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add Transaction Details</h1>
        ...
        <form method="POST" action="{{route('transaction.store')}}">
            ...
            <div class="card-body">
                <div class="form-group row">
                      ...
                      <!--<select class="col-md-9 form-control form-control-user @error('customer_id') is-invalid @enderror" name="customer_id" id="customer_id">-->
                    ...
                    <div class="dropdown show w-100">
                      <a class="btn btn-white dropdown-toggle form-control form-control-user @error('customer_id') is-invalid @enderror" href="#" role="button" id="customer_name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Select Customer</a>
                    <input type='hidden' class="form-control form-control-user" placeholder="search customer" name="customer_id" id="customer_id">
                    ...
                    <div class="dropdown show w-100">
                      <a class="btn btn-white dropdown-toggle form-control form-control-user @error('company') is-invalid @enderror" href="#" role="button" id="company_name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Select Company</a>
                    <input type='hidden' class="form-control form-control-user" placeholder="search customer" name="company" id="company">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                     <label><span style="color:red;">*</span> Description</label>
                      <textarea class="form-control form-control-user" id="description" placeholder="Description" rows="1" name="description"></textarea>  
                      </div>
  <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
