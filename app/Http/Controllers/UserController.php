...
class UserController extends Controller
{
    ...
    public function activitylog(Request $request, $user)
    {
         ...
         $activitys = DB::table('activity_log')->where('user_id', $user)->get();
         ...
         foreach($activitys as $activity){
             ...
             $activity->managename = $manage->first_name;
             $activity->username = $user->first_name.' '.$user->last_name;
             $activity->rolename = $role->name;
         }
         
        return view('users.activitylog', ['activitys' => $activitys]);
